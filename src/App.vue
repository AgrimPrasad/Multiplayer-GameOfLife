        ...
        >
          ...
          <div class="modal-card">
            ...
            <footer class="modal-card-foot">
              <button class="button is-success" @click="importSession">
                Import
              </button>
...
export default {
  ...
  methods: {
     ...
     * to signal start of simulation if
     * not started already
     */
    clickStart: function() {
      const socketID = this.$socket.id;
     ...
     * to signal pause of simulation if
     * not paused already
     */
    clickPause: function() {
      const socketID = this.$socket.id;
    ...
    /**
     * Changes isRunning based on param.
     *
     * @param {bool} isRunning - updated isRunning status
     */
    updateIsRunning: function(isRunning) {
